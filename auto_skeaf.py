...
if shift_intervals > 0:
    ...
    for Ef_shift in np.arange(min_shift, max_shift, shift_intervals):
        ...
        for file in files:
            ...
            if (
                min_energy <= Ef_float_shifted
                and max_energy >= Ef_float_shifted
            ):
        ...
        plt.savefig(
            file_name + "_" + str(Ef_float_shifted) + ".png",
            format="png",
            dpi=1200,
        )
    ...
    for file in files:
        ...
        if min_energy <= Ef_float and max_energy >= Ef_float:
            ...
            os.rename(
                "results_freqvsangle.out",
                file_name + "_" + Ef.strip() + "." + band_name + ".c-a.out",
            )
            ...
            os.rename(
                "results_freqvsangle.out",
                file_name + "_" + Ef.strip() + "." + band_name + ".c-b.out",
            )
